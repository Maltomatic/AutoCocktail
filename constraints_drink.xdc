...
# # Sch name = JA9
# set_property PACKAGE_PIN H2 [get_ports {m_wa}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {m_wa}]
# # Sch name = JA10
...
set_property PACKAGE_PIN A16 [get_ports {m_wh}]
   set_property IOSTANDARD LVCMOS33 [get_ports {m_wh}]
# Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {m_vo}]
   set_property IOSTANDARD LVCMOS33 [get_ports {m_vo}]
# Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {m_ly}]
   set_property IOSTANDARD LVCMOS33 [get_ports {m_ly}]
# Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {m_li}]
   set_property IOSTANDARD LVCMOS33 [get_ports {m_li}]
# Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {m_le}]
   set_property IOSTANDARD LVCMOS33 [get_ports {m_le}]
# Sch name = JB9
...
set_property PACKAGE_PIN K17 [get_ports {st_pwm}]
   set_property IOSTANDARD LVCMOS33 [get_ports {st_pwm}]
# # Sch name = JC2
# set_property PACKAGE_PIN M18 [get_ports {m_le}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {m_le}]
# # Sch name = JC3
# set_property PACKAGE_PIN N17 [get_ports {m_wa}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {m_wa}]
# ## Sch name = JC4
#  set_property PACKAGE_PIN P18 [get_ports {st}]
#     set_property IOSTANDARD LVCMOS33 [get_ports {st}]
## Sch name = JC7
...
# STREAM.GENERAL.COMPRESS TRUE [current_design]
# set_property BITSTREAM.CONFIG.SPI_BUSWIDTH 4 [current_design]
# set_property CONFIG_MODE SPIx4 [current_design]
