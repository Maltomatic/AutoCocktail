...
HD_PWD='C:/Users/justi/Documents/verilog_lab/final_project/drinkinator/drink_master/drink_master.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log drinkinator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source drinkinator.tcl
