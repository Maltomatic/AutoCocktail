...
HD_PWD='C:/Users/justi/Documents/verilog_lab/final_project/drinkinator/drink_master/drink_master.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log drinkinator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source drinkinator.tcl -notrace
